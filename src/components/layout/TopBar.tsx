...
export default function TopBar({}: Props): ReactElement {
  ...
  return (
    <div className="bg-white w-full py-2 px-8 flex gap-4 item-center ">
      {/* logo container */}
      ...
      <div className="flex gap-2 font-extrabold  text-xs  ">
        <button
          className={`  rounded py-1 px-2 hover:bg-black hover:text-white  ${router.pathname  === "/main/men" ? "bg-black text-white" : ''} `}
        >
          {console.debug(router.pathname)}
          WOMEN
        </button>
        <button className={`rounded py-1 px-2 hover:bg-black hover:text-white ${router.pathname  === "/main/women" ? "bg-black text-white" : ''}`}>
          MEN
        </button>
      </div>
